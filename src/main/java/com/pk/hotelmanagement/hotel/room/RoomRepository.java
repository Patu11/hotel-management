...
public interface RoomRepository extends JpaRepository<Room, Integer> {
    ...
    @Query(value = "SELECT room_id AS roomId, num_of_people AS numberOfPeople, price, description FROM room WHERE hotel_id = :hotelId", nativeQuery = true)
    List<RoomDTO> findAllByHotelId(@Param("hotelId") int hotelId);
}
